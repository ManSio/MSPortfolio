...
describe('worker /mcp integration', () => {
  it('tools/list exposes 14 tools with readOnlyHint annotations', async () => {
  ...
  it('/openapi.json (D5): valid OpenAPI doc describing /mcp and listing 14 tools', async () => {
    ...
    expect(doc['x-mcp-tools']).toHaveLength(14);
  });
